...
> - **验收测试清单**：docs/acceptance-test.md（21 模块 220 条可执行验收项，逐条=步骤+预期结果，全绿=完整性验收通过；15 对话体验域 20 条覆盖 14 交互域，16 企业级 30 条覆盖 13 子域，17 教训域 20 条覆盖 14 域，18 生态 14 条覆盖 9 类，19 布局 14 条覆盖 7 域，20 底层 14 条覆盖 7 域，21 文档 14 条覆盖 7 域）
