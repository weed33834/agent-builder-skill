...
const RES: ResTree = {
  zh: {
    ...
    auth: {
      ...
      register_success: '注册成功，欢迎加入心镜',
      forgot_sent: '密码重置邮件已发送，请检查邮箱',
      brand_quote: '镜不言，只照',
  ...
  en: {
    ...
    auth: {
      ...
      register_success: 'Account created. Welcome to MindMirror.',
      forgot_sent: 'Password reset email sent. Check your inbox.',
      brand_quote: 'The mirror speaks not; it only reflects.',
  ...
  ja: {
    ...
    auth: {
      ...
      register_success: 'アカウントを作成しました。心鏡へようこそ。',
      forgot_sent: 'パスワードリセットメールを送信しました。メールボックスを確認してください。',
      brand_quote: '鏡は語らず、ただ映す',
