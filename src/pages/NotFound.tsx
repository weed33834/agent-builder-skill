...
export default function NotFound() {
  ...
  return (
    <div className="nf-wrap flex flex-col items-center justify-center text-center px-6" style={{ minHeight: '70vh', position: 'relative', overflow: 'hidden' }}>
      ...
      <InkBlot style={{ position: 'absolute', bottom: '10%', right: '10%', width: '260px', height: '260px', pointerEvents: 'none', opacity: 0.3, zIndex: 0 }} />
      ...
      <img src={asset('/images/404-broken-mirror.jpg')} className="nf-illustration mb-6" style={{ position: 'relative', zIndex: 1 }} alt="" aria-hidden="true" />
      ...
      <SealStamp style={{ position: 'absolute', bottom: '20px', right: '20px', width: '52px', height: '52px', opacity: 0.5, pointerEvents: 'none' }} />
    </div>
  )
}
